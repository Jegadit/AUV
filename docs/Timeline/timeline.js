jQuery(document).ready(function($){
	...
	function updateVisibleContent(event, eventsContent) {
		...
		// Update the background image based on the selected event
		var backgroundImage = selectedContent.data('background-image');
		if (backgroundImage) {
			$('body').css({
		...
		eventsContent.find('li').not(selectedContent).addClass('hidden');
